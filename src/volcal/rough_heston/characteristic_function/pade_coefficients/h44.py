"""Legacy (4,4) expanded coefficient formulas, retained for audit.
...
def coefficients(u, params):
    ...
    # Coeficientes del denominador de Padé (4,4)
    ...
    # Coeficientes del numerador de Padé (4,4)
    p1 = b1
    p2 = b2 + b1*q1
    p3 = b3 + b1*q2 + b2*q1
    p4 = g0 * q4

    return (np.array([0j, p1, p2, p3, p4], dtype=np.complex128),
            np.array([1+0j, q1, q2, q3, q4], dtype=np.complex128))
